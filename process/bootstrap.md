...
4. 必要な共有ライブラリを、[tools/build/git-submodule](../tools/build/git-submodule.md) が定める取得機構で target の `libs/<mechanism>` へ初期化し、target が記録した exact commit のコードと `spec.md` を materialize する。
