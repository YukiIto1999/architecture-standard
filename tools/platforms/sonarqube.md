...
用途は、認知的複雑さを quality gate で検査する、セルフホストの検査の基盤である。
採用は、SonarQube Community Build のセルフホストと、その cognitive complexity(S3776)と quality gate である。
判断基準は、無償の Community Build が cognitive complexity(S3776)と quality gate を提供し、switch や match の構造化を一度だけ加点して閉じた直和の網羅的な分岐を罰さず、セルフホストが 1 顧客 1 配備と整合することである。
撤回条件は、無償の Community Build で判断基準の提供が続かなくなることであり、リリースポリシーと同梱アナライザの許諾の範囲の変化を再評価のトリガーとする。
