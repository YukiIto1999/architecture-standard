...
is_non_product_token() {
  ...
  case "$1" in
    ...
    "analyzer"|"backend"|"client"|"ID"|"cognitive"|"collector"|"commit"|"tree"|"companion"|"complexity"|"cookie"|"core"|"coverage"|"desktop"|"for"|"framing"|"gate"|"generation"|"generator"|"handler"|"library"|"mobile"|"node"|"one-time"|"package"|"plugin"|"project"|"provider"|"quality"|"queue"|"record"|"repository"|"root"|"runtime"|"rust"|"schema"|"script"|"sealed"|"source"|"tests/"|"tools"|"type-aware"|"union"|"up"|"v1"|"v8")
      return 0
      ;;
    *)
      return 1
