...
各概念は [principles](../principles/) の抽象的な設計原則を全系レベルの規律として具象化し、[structure](../structure/)、[tools](../tools/)、[languages](../languages/) はこれらの規律を参照してシステムの骨格と技術選定を実現します。
...
台帳の行は、規律の link に続けて、その規律を何で検証するかを括弧で示します。README の末尾には、他の概念と領域への参照を置きます。
...
概念フォルダを分ける単位は、structure、tools、languages が独立して名指し、従うための契約です。
