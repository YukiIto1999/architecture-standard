...
- [domain event と integration event を分ける](./domain-integration-events.md)
- [同期で済む連携はイベントにしない](./async-only-events.md)
- [outbox から配送する](./outbox-delivery.md)
- [少なくとも一度の配送を前提に冪等に消費する](./idempotent-consumption.md)
- [順序・再試行・行き止まりを扱う](./ordering-retry-deadletter.md)
- [イベント契約を版で進化させ、寛容に読む](./event-contract-versioning.md)
